"""autogenerated by genpy from wall_detection/Lines2D.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import wall_detection.msg

class Lines2D(genpy.Message):
  _md5sum = "f402e3a4c1723d3fbb8f7105142104da"
  _type = "wall_detection/Lines2D"
...
"""
  ...
  _slot_types = ['wall_detection/Line2D[]','bool','int32[]','int32[]','int32[]','int32[]','int32[]','int32[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = wall_detection.msg.Line2D()
        _x = val1
        start = end
        end += 20
